package com.gmail.vanyasudnishnikov.application.controllers.config;
...
@Configuration
@EnableFeignClients(basePackages = "com.gmail.vanyasudnishnikov.application.repository.feign")
